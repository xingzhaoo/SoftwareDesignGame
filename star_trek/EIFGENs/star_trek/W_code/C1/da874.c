...
extern EIF_TYPED_VALUE F874_7036(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7038(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7039(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7040(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7041(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7042(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7043(EIF_REFERENCE);
...
EIF_TYPED_VALUE F874_7036 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F874_7036,12726,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F874_7037)
EIF_TYPED_VALUE F874_7037 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 12718);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(873, Current, 12718);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F874_7038)
EIF_TYPED_VALUE F874_7038 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 12719);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(873, Current, 12719);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000123, 0,0); /* Result */
...
RTOID (F874_7039)
EIF_TYPED_VALUE F874_7039 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 12720);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(873, Current, 12720);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000123, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 12721);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(873, Current, 12721);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000123, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F874_7041,12723,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F874_7042 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F874_7042,12724,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F874_7043 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F874_7043,12725,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit874 (void)
{
	GTCX
	RTOTS (7036,F874_7036)
	RTOTS (7037,F874_7037)
	RTOTS (7038,F874_7038)
	RTOTS (7039,F874_7039)
	RTOTS (7040,F874_7040)
	RTOTS (7041,F874_7041)
	RTOTS (7042,F874_7042)
	RTOTS (7043,F874_7043)
}
