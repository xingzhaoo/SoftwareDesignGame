...
extern EIF_TYPED_VALUE F883_7112(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7113(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7114(EIF_REFERENCE);
...
EIF_TYPED_VALUE F883_7112 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F883_7113 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F883_7114 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12781);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(882, Current, 12781);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(4990, "fractional_second", tr1));
